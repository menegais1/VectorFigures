...
Button::Button(Float3 position, Float3 scale, Float3 backgroundColor, string title, Float3 textColor) : backgroundColor(backgroundColor), title(title), textColor(textColor)
{
